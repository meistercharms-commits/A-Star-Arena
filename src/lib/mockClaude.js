...
const questionBank = {
  ...
  chemical_industry: {
    ...
    application: [
      ...
      { prompt: "A ¹H NMR spectrum shows peaks at δ 1.2 (triplet, 3H), δ 2.4 (quartet, 2H) and δ 9.8 (singlet, 1H). Suggest the structure of the compound.", subskillIds: ["nmr_ci"], keywords: ["propanal", "CH₃CH₂CHO", "triplet at 1.2 = CH₃", "quartet at 2.4 = CH₂", "singlet at 9.8 = CHO aldehyde"], maxScore: 4 },
    ],
    extended: [
  ...
  polynomials: {
    ...
    extended: [
      { prompt: "f(x) = 2x³ + ax² + bx - 6. Given that (x - 1) is a factor of f(x) and that f(2) = 12, find the values of a and b. Hence factorise f(x) completely. (6 marks)", subskillIds: ["factor_theorem", "algebraic_division"], keywords: ["f(1) = 0", "f(2) = 12", "simultaneous equations", "a = -3", "b = 7", "factorise"], maxScore: 6, rubricPoints: ["f(1) = 0: 2 + a + b - 6 = 0, so a + b = 4", "f(2) = 12: 16 + 4a + 2b - 6 = 12, so 4a + 2b = 2, hence 2a + b = 1", "Solve simultaneously: a + b = 4 and 2a + b = 1 gives a = -3, b = 7", "With a = -3 and b = 7, divide f(x) = 2x³ - 3x² + 7x - 6 by (x-1) using algebraic long division", "Factorise the resulting quadratic", "State all three linear factors"] },
      { prompt: "Use the binomial expansion to find the first 4 terms of (1 - 2x)^8 in ascending powers of x. State the range of values of x for which the expansion is valid. (6 marks)", subskillIds: ["binomial_expansion"], keywords: ["8C0", "8C1(-2x)", "8C2(-2x)²", "8C3(-2x)³", "1 - 16x + 112x² - 448x³", "valid for all real x since n is a positive integer"], maxScore: 6, rubricPoints: ["First term: 8C0 × 1⁸ × (-2x)⁰ = 1", "Second term: 8C1 × (-2x)¹ = 8 × (-2x) = -16x", "Third term: 8C2 × (-2x)² = 28 × 4x² = 112x²", "Fourth term: 8C3 × (-2x)³ = 56 × (-8x³) = -448x³", "Expansion: 1 - 16x + 112x² - 448x³ + ...", "Valid for all real x (since n=8 is a positive integer, the expansion terminates)"] },
    ],
  },
  trigonometry_1: {
    recall: [
  ...
  artist_research: {
    recall: [
      ...
      { prompt: "Name one modern art movement.", keywords: ["Cubism", "Surrealism", "Pop Art", "Abstract Expressionism", "Expressionism"], maxScore: 1 },
    ],
    application: [
